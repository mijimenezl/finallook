...
st.markdown("""
    <h1 style='text-align: center;'>📊 Análisis de Datos de Sensores en Mi Ciudad</h1>
    <div style="background-color:#1c097a; padding:1rem; border-radius:8px; margin-bottom:1.5rem; text-align: center;">
